...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Prep.Func.Export.Model
{
    ...
    public class UserData
    {
        ...
        /// <summary>
        /// Gets or sets the reaction survey value.
        /// </summary>
        public string ReactionSurvey { get; set; }

        /// <summary>
        /// Gets or sets the free text survey value.
        /// </summary>
        public string FreeTextSurvey { get; set; }

        /// <summary>
        /// Gets or sets the free text survey value.
        /// </summary>
        public string YesNoSurvey { get; set; }
    }
}