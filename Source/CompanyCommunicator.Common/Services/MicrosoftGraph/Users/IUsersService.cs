...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Services.MicrosoftGraph
{
    ...
    public interface IUsersService
    {
        ...
        /// get user by email.
        /// </summary>
        /// <param name="userEmails">the user id.</param>
        /// <returns>user data.</returns>
        public Task<IEnumerable<User>> GetUserEmailAsync(IEnumerable<string> userEmails);
        ...
        public Task<(IEnumerable<User>, string)> GetAllUsersAsync(string deltaLink = null);
