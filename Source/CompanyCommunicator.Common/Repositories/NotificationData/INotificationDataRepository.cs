...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Repositories.NotificationData
{
    ...
    public interface INotificationDataRepository : IRepository<NotificationDataEntity>
    {
        ...
        /// <summary>
        /// Get non erased and expired notification entities from the table storage.
        /// </summary>
        /// <returns>All pending scheduled notification entities.</returns>
        public Task<IEnumerable<NotificationDataEntity>> GetNonErasedExpiredNotificationsAsync();
        ...
        /// <summary>
        /// Updates expired notification content.
        /// </summary>
        /// <param name="notificationId">Notificaion Id.</param>
        /// <param name="content">Content.</param>
        /// <returns><see cref="Task"/> representing the asynchronous operation.</returns>
        public Task UpdateExpiredNotificationAsync(string notificationId);
