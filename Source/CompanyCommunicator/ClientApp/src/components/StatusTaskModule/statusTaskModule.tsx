...
import {
    ...
    setCardAuthor, setCardBtn, setCardBtn2, setCardBtn3, setCardBtn4, setCardBtn5, setVideoBtn, setSenderTemplate,
    setBoldSummary, setFontSummary, setAlignmentSummary, setFontSizeSummary, setFontColorSummary, setReaction, SetReactionQuestion, SetFreeText, SetFreeTextQuestion, setYesNo, setYesNoQuestion, setSubmitBtn, setToggleLinktoSurvey, setLinktoSurvey
...
class StatusTaskModule extends React.Component<StatusTaskModuleProps, IStatusState> {
    ...
    private renderAudienceSelection = () => {
        ...
        } else if (this.state.message.uploadedList) {
            return (
                <div>
                    <h3>Custom Upload List</h3>
                </div>);
        } else {
            return (<div></div>);
        }
