...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Repositories.NotificationData
{
    ...
    public class NotificationDataEntity : TableEntity
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the Survey Reaction value.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the Survey Free Text value.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the Survey yes/no value.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the Survey Link value.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the UploadedList value.
        /// This property helps to save the Grousp list in the Azure Table storage.
        /// Table storage doesn't support an array type of the property directly
        /// so this is a comma separated list of the group ids for which the members
        /// are the recipients.
        /// </summary>
        public string UploadedListString { get; set; }

        /// <summary>
        /// Gets or sets the team ids of the UploadList audience collection.
        /// </summary>
        [IgnoreProperty]
        public IEnumerable<string> UploadedList
        {
            get => JsonConvert.DeserializeObject<IEnumerable<string>>(this.UploadedListString.IsNullOrEmpty() ? "[]" : this.UploadedListString);
            set => this.UploadedListString = JsonConvert.SerializeObject(value);
        }
