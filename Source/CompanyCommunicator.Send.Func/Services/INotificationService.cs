...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Send.Func.Services
{
    ...
    public interface INotificationService
    {
        ...
        /// <param name="reactionResult">The error message to store in the database.1.</param>
        /// <param name="freeTextResult">The error message to store in the database.2.</param>
        /// <param name="yesNoResult">The error message to store in the database.3.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
