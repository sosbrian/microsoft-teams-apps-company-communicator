...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Prep.Func.PreparingToSend
{
    ...
    public class SyncGroupMembersActivity
    {
        ...
        [ActivityTrigger](string notificationId, string groupId, string exclusionL) input, ILogger log)
        {
        ...
        private async Task<IEnumerable<SentNotificationDataEntity>> GetRecipientsAsync(string notificationId, IEnumerable<User> users, string exclusionL)
        {
